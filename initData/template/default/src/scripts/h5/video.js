(function(){
  ...
  requireJs(['jQuery', 'utils', 'sharePage', 'aplayer', 'sinaWeixinConfigReady', 'scrollToBottom', 'motu'],
    function (jQuery, utils, sharePage, aplayer, sinaWeixinConfigReady, scrollToBottom) {
      ...
      // 获取视频数据
      newApp.getVideoInfo(__pageConfig.__videoId);
